...
This repository contains the source code for the Python package `scanwidth` aimed at computing the scanwidth of directed acyclic graphs (DAGs). If you use
the package, please cite the corresponding paper, which describes the implemented algorithms.
